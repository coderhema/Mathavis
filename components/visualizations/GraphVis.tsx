...
const GraphVis: React.FC<GraphVisProps> = ({ data }) => {
  ...
  return (
    <div className="w-full h-full rounded-2xl overflow-hidden relative transition-colors group" style={{ background: 'var(--bg2)', borderWidth: 2, borderColor: 'var(--border)', borderStyle: 'solid' }}>
