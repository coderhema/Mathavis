...
const FlowchartVis: React.FC<FlowchartVisProps> = ({ data }) => {
  ...
  return (
    <div className="w-full h-full min-h-[400px] rounded-2xl overflow-hidden transition-colors relative group" style={{ background: 'var(--bg2)', border: '2px solid var(--border)' }}>
